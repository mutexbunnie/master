...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Sun Oct 21 13:11:13 2012
# Project:  master.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/master1.0.0/ && $(COPY_FILE) --parents mainform.h entity.h activedialog.h entitytype.h entitytypebutton.h fielddescription.h fieldmap.h projectstore.h stringintturple.h datasource.h mysqldatasource.h graphicsscene.h entityicon.h edge.h .tmp/master1.0.0/ && $(COPY_FILE) --parents icons.qrc .tmp/master1.0.0/ && $(COPY_FILE) --parents main.cpp mainform.cpp entity.cpp activedialog.cpp entitytype.cpp entitytypebutton.cpp fieldmap.cpp projectstore.cpp stringintturple.cpp datasource.cpp mysqldatasource.cpp graphicsscene.cpp entityicon.cpp edge.cpp .tmp/master1.0.0/ && $(COPY_FILE) --parents mainform.ui .tmp/master1.0.0/ && (cd `dirname .tmp/master1.0.0` && $(TAR) master1.0.0.tar master1.0.0 && $(COMPRESS) master1.0.0.tar) && $(MOVE) `dirname .tmp/master1.0.0`/master1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/master1.0.0
...
compiler_moc_header_make_all: moc_mainform.cpp moc_entity.cpp moc_activedialog.cpp moc_entitytypebutton.cpp moc_graphicsscene.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainform.cpp moc_entity.cpp moc_activedialog.cpp moc_entitytypebutton.cpp moc_graphicsscene.cpp
