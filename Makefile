...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Sep 3 18:05:24 2012
# Project:  master.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		activedialog.cpp \
		entitytype.cpp \
		entitytypebutton.cpp moc_mainform.cpp \
		moc_entity.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/master1.0.0/ && $(COPY_FILE) --parents mainform.h entity.h activedialog.h entitytype.h entitytypebutton.h .tmp/master1.0.0/ && $(COPY_FILE) --parents icons.qrc .tmp/master1.0.0/ && $(COPY_FILE) --parents main.cpp mainform.cpp entity.cpp activedialog.cpp entitytype.cpp entitytypebutton.cpp .tmp/master1.0.0/ && $(COPY_FILE) --parents mainform.ui .tmp/master1.0.0/ && (cd `dirname .tmp/master1.0.0` && $(TAR) master1.0.0.tar master1.0.0 && $(COMPRESS) master1.0.0.tar) && $(MOVE) `dirname .tmp/master1.0.0`/master1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/master1.0.0
