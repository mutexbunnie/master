...
void GraphicSheet::constructToolbar()
{
    actionSelection = new QAction(toolbar);
    ...
    actionLink = new QAction(toolbar);
    ...
    actionDotLayout = new QAction(toolbar);
    ...
    actionNeatoLayout = new QAction(toolbar);
  ...
  //  actionNeatoLayout->setCheckable(true);
    ...
    actionfdpLayout = new QAction(toolbar);
   ...
   // actionfdpLayout->setCheckable(true);
    ...
    actionsfdpLayout = new QAction(toolbar);
    ...
    actionelasticLayout = new QAction(toolbar);
    ...
    actionAutoLink = new QAction(toolbar);
    ...
    actionRemove = new QAction(toolbar);
    ...
    actionAutoZoom = new QAction(toolbar);
